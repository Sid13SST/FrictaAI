        ...
        <SignIn
          ...
          appearance={{
            ...
            elements: {
              ...
              formButtonPrimary: 'btn-primary-cta hover:bg-[#5C2FC2] border-none text-[#070b0a] font-bold text-sm uppercase',
              footerActionText: 'text-white/40',
              footerActionLink: 'text-accent hover:text-[#5C2FC2] transition-colors',
