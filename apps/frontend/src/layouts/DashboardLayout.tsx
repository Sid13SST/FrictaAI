...
import { LayoutDashboard, PlaySquare, FileText, Users, Settings, Brain, ChevronRight, Share2, Compass, TrendingUp, Zap, Sparkles, Cpu, Link2, GitBranch, GitMerge, ShieldCheck, MessageSquare, Terminal, Activity, FlaskConical, Target, Award } from 'lucide-react';
...
export const DashboardLayout = () => {
  ...
  const navItems = [
    ...
    { name: 'Portfolio Alignment', path: '/app/portfolio-intelligence', icon: GitMerge, desc: 'Strategy Alignment' },
