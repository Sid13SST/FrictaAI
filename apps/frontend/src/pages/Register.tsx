        ...
        <SignUp
          ...
          appearance={{
            ...
            elements: {
              ...
              formButtonPrimary: 'btn-primary-cta hover:bg-[#6edba8] border-none text-[#070b0a] font-bold text-sm uppercase',
              footerActionText: 'text-white/40',
              footerActionLink: 'text-accent hover:text-[#6edba8] transition-colors',
